...
def listen_print_loop(responses):
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            print final
	    if final == "Saya follow me":
                chunk = 1024
		wf = wave.open('/home/asimov16/google_speech_ws/python-docs-samples-master/speech/cloud-client/follow.wav', 'rb')
		p = pyaudio.PyAudio()
